...
类型:{邮件:“这个值应该是一个有效的电子邮件。”,
url:“这个值应该是一个有效的url。”,
urlstrict:“这个值应该是一个有效的url。”,
数字:“这个值应该是一个有效的号码。”,
数字:“这个值应该是数字。”
...
马克斯:“这个值应低于或等于% s。”,
范围:“这个值应该%和%年代。”之间,
最小长度:“这个值太短了。它应该有% s字符或更多。”
最大长度:“这个值是太长了。它应该有% s字符或更少。”
rangelength:“这个值长度是无效的。它应该是%和%年代人物之间长了。”
mincheck:“你必须选择至少% s的选择。”,
maxcheck:“你必须选择% s的选择或更少。”,
rangecheck:“你必须选择%和%年代之间选择。”,
等于:“这个值应该是相同的。\" };
    */
!(function (d) {
  var h = function (a) {
    this.messages = {
      defaultMessage: "정확하게 입력하세요!",
      type: {
        email: "이메일 형식을 올바르게 입력하세요!",
        url: "링크 형식을 올바르게 입력하세요!",
        urlstrict: "URL 형식을 올바르게 입력하십시오!",
        number: "숫자 형식 만 허용됩니다!",
        range: "범위 형식을 올바르게 입력하십시오! 예:[10,50]",
        mobile: "전화 번호를 정확하게 입력하세요",
        digits: "정수만 허용됩니다!",
        dateIso: "날짜 형식을 정확하게 입력하십시오 (YYYY-MM-DD).",
        alphanum: "숫자와 문자 만 허용",
        phone: "전화 번호를 정확하게 입력하세요",
        user_id:
          "아이디는 영문으로 시작해야 하고, 영문, 숫자, 밑줄(_)만 사용할 수 있으며 길이는 6자 이상 20자 이하여야 합니다.",
      },
      notnull: "이 값은 비워 둘 수 없습니다..",
      notblank: "이 값은 비워 둘 수 없습니다.",
      required: "이 값은 필수 입력(선택)입니다.",
      regexp: "이 값은 잘못된 것 같습니다.",
      min: "%s미만의 숫자 만 입력하십시오.",
      max: "%s이상의 숫자 만 입력하십시오.",
      range: "%s-%s 사이숫자만 입력하세요",
      minlength: "%s 자 이상이어야합니다.",
      maxlength: "%s 자 이하이어야합니다.",
      rangelength: "%s-%s글자 이내로 입력하세요",
      mincheck: "%s이상을 선택하십시오",
      maxcheck: "%s이상를 선택하십시오",
      rangecheck: "%s-%s을 (를) 선택하십시오",
      equalto: "동일한 값을 입력하십시오.",
      remote: "이미 사용중이거나 금지된 값입니다.",
    };
    this.init(a);
  };
  h.prototype = {
  ...
  d.fn.parsley.defaults = {
    ...
    excluded: "input[type=hidden], :disabled, .summernote",
    trigger: !1,
    animate: !0,
    animateDuration: 300,
    focus: "first",
    ...
    errors: {
      ...
      errorElem: "<label class=error></label>",
    },
    listeners: {
