    ...
    */
    ...
    var ResourceDayHeader = /** @class */ (function (_super) {
        ...
        ResourceDayHeader.prototype.render = function () {
            var _this = this;
            var _a = this, props = _a.props, context = _a.context, nodes = props.rowNodes;

            var dateFormat = this.buildDateFormat(context.options.dayHeaderFormat, props.datesRepDistinctDays, props.dates.length);
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) {
                if (props.dates.length === 1) {
                    return _this.renderResourceRow(props.resources, props.dates[0], props.rowNodes, props.colSpecs, nodes);
                }
                if (context.options.datesAboveResources) {
                    return _this.renderDayAndResourceRows(props.dates, dateFormat, todayRange, props.resources, nodes);
                }
                return _this.renderResourceAndDayRows(props.resources, props.dates, dateFormat, todayRange, nodes);
            }));
        };

        /*  ResourceDayHeader.prototype.renderSpreadsheetRows = function (nodes, colSpecs, rowSyncHeights) {
        ...
        ResourceDayHeader.prototype.renderResourceRow = function (resources, date, nodes, colSpecs, rowSyncHeights) {
            ...
            var resourceGroupCells = nodes.map(function (node) {
                var colSpan = node.rowSpans;
                if (colSpan > 1) {
                    return (createElement(ResourceCell, { key: node.id, resource: node.resource, colSpan: colSpan, date: date }));
                }
            });
            return (createElement(Fragment, null, resourceGroupCells,
                this.buildTr(resourceCells, 'resources')
            ));
        };
        ResourceDayHeader.prototype.renderDayAndResourceRows = function (dates, dateFormat, todayRange, resources, nodes) {
            var dateCells = [];
            var resourceCells = [];
            var resourceGroupCells = [];
            for (var _i = 0, dates_1 = dates; _i < dates_1.length; _i++) {
                ...
                for (var _a = 0, nodes_1 = nodes; _a < nodes_1.length; _a++) {
                    ...
                    var colSpan = node.rowSpans;
                    if (colSpan > 1) {
                        resourceGroupCells.push(createElement(ResourceCell, { key: node.id, resource: node.resource, colSpan: colSpan, date: date }));
                    }
                }
            }
            ...
            return (createElement(Fragment, null,
                ...
                this.buildTr(resourceGroupCells, 'day'),
                this.buildTr(resourceCells, 'resources')));
        };
    ...
    var SpreadsheetRow2 = /** @class */ (function (_super) {
        __extends(SpreadsheetRow2, _super);
        function SpreadsheetRow2() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        SpreadsheetRow2.prototype.render = function () {
            var props = this.props;
            ...
            return (createElement("tr", { role: "row" }, props.colSpecs.map(function (colSpec, i) {
                ...
                if (rowSpan > 1) {
                    ...
                    return (
                        createElement("td", { ref: "rootElRef", role: "gridcell", rowSpan: 3, className: ['fc-datagrid-cell', 'fc-resource-group'].concat(classNames).join(' ') },
                        )
                    );
                }
            })));
        };
        return SpreadsheetRow2;
    }(BaseComponent));
    SpreadsheetRow2.addPropsEquality({
    ...
    */
    ...
    var ResourceDayTimeColsView = /** @class */ (function (_super) {
        ...
        ResourceDayTimeColsView.prototype.render = function () {
            ...
            var hasAttachedAxis = !dayMinWidth;
            var hasDetachedAxis = dayMinWidth;
            var headerContent = options.dayHeaders && (createElement(ResourceDayHeader, { rowNodes: rowNodes, colSpecs: colSpecs, resources: resources, dates: resourceDayTableModel.dayTableModel.headerDates, dateProfile: dateProfile, datesRepDistinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
